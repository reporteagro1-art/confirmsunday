  ...
  return (
    <div className="min-h-screen bg-[#fafaf8] flex flex-col items-center justify-center px-4 py-12">
      <div className="w-full max-w-sm">
        ...
        <p className="text-gray-400 text-sm text-center mb-8">Screen preview</p>
        ...
        <div className="flex flex-col gap-2">
          {screens.map(s => (
            ...
            >
              <div>
                <div className="text-base font-medium group-hover:text-[#2563eb] transition-colors">{s.label}</div>
                <div className="text-sm text-gray-400">{s.desc}</div>
              </div>
              <span className="text-gray-300 group-hover:text-[#2563eb] transition-colors text-lg">→</span>
            </Link>
          ))}
        </div>
      </div>
