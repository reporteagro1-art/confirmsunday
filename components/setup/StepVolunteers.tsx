...
export default function StepVolunteers({ volunteers, onChange, onNext, onBack }: Props) {
  ...
  return (
    <div>
      ...
      <div className="bg-[#eff6ff] border border-[#bfdbfe] rounded-lg px-4 py-3 text-xs text-[#1d4ed8] mb-4 font-light">
        Example format:<br />
      ...
      <div className="mb-3">
        <textarea
          ...
          rows={6}
          className="w-full px-4 py-3 border border-[#e8e6e0] rounded-lg text-sm bg-white focus:outline-none focus:ring-2 focus:ring-[#2563eb] focus:border-transparent placeholder-gray-300 font-mono resize-none transition"
        />
      </div>
      ...
      <button
        onClick={handleParse}
        className="bg-white border border-[#e8e6e0] hover:border-gray-400 text-gray-700 font-medium py-2 px-4 rounded-lg text-sm transition-colors mb-6"
      >
        Parse list →
      </button>
      ...
      <div className="flex justify-between">
        <button
          onClick={onBack}
          className="bg-white border border-[#e8e6e0] hover:border-gray-400 text-gray-700 font-medium py-3 px-6 rounded-lg text-sm transition-colors"
        >
          ← Back
        </button>
        <button
